...
def train_diagnostics_model(model, X_train_scaled, y_train_cat, X_val_scaled, y_val_cat, model_save_path="best_model_diagnostics.keras"):
    """
    ...
    early_stop = EarlyStopping(
        ...
        mode='max'                             # Maximize accuracy (higher is better)
    )
