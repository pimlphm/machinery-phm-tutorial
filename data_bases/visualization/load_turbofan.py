...
def load_turbofan_data(extract_path="turbofan_data"):
    ...
    print("\n" + "="*80)
    print("C-MAPSS TURBOFAN DATASET SUMMARY")
    print("="*80)
    ...
    print("\nSENSOR CHANNELS BY SYSTEM:")
    print("\n🌍 ENVIRONMENTAL CONDITIONS:")
    print("  setting1 - Altitude (operational altitude setting)")
    print("  setting2 - Mach number (speed setting)")
    print("  setting3 - Throttle resolver angle (power setting)")
    
    print("\n🌡️ TEMPERATURE SENSORS:")
    print("  sensor_1 - Total temperature at fan inlet (T2)")
    print("  sensor_2 - Total temperature at LPC outlet (T24)")
    print("  sensor_3 - Total temperature at HPC outlet (T30)")
    print("  sensor_4 - Total temperature at LPT outlet (T50)")
    
    print("\n💨 PRESSURE SENSORS:")
    print("  sensor_5 - Pressure at fan inlet (P2)")
    print("  sensor_6 - Total pressure in bypass-duct (P15)")
    print("  sensor_7 - Total pressure at HPC outlet (P30)")
    print("  sensor_10 - Engine pressure ratio (P30/P2)")
    print("  sensor_11 - Static pressure at HPC outlet (Ps30)")
    
    print("\n⚙️ ROTATIONAL SPEED SENSORS:")
    print("  sensor_8 - Physical fan speed (Nf)")
    print("  sensor_9 - Physical core speed (Nc)")
    print("  sensor_13 - Corrected fan speed")
    print("  sensor_14 - Corrected core speed")
    print("  sensor_18 - Required fan speed")
    print("  sensor_19 - Required core speed")
    
    print("\n⛽ FUEL SYSTEM SENSORS:")
    print("  sensor_12 - Ratio of fuel flow to Ps30")
    print("  sensor_16 - Burner fuel-air ratio")
    
    print("\n🔧 ENGINE PERFORMANCE SENSORS:")
    print("  sensor_15 - Bypass Ratio")
    print("  sensor_17 - Bleed Enthalpy")
    print("  sensor_20 - High pressure turbine efficiency")
    print("  sensor_21 - Low pressure turbine efficiency")
